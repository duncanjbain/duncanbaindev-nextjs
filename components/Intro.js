    ...
    <section className="px-8 md:py-2 mb-8">
      <p className="text-2xl md:text-4xl font-bold text-blue-500 mb-4">
        ...
        <p className="font-normal text-xl md:text-2xl md:leading-relaxed">
          I&apos;m a Mechanical Engineer who&apos;s learning to code. This is where I
          share the things that I&apos;ve created, where I write about the things
          that I&apos;m working on and where I talk about anything else that excites
          me. Feel free to get in touch with me on{" "}
          <a
